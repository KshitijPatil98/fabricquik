...
- CORE_VM_DOCKER_HOSTCONFIG_NETWORKMODE=fabric_test (this should be same as name of docker network)
...
#There is absolutely no need of this but we will still keep it
